...
export type UserItemFragment = { __typename?: 'UserQueryData', email: string, userId: any, username: string } & { ' $fragmentName'?: 'UserItemFragment' };
...
export type LoginQuery = { __typename?: 'QueryRoot', user: (
    { __typename?: 'UserQueryData' }
